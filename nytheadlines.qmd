...
title: "NYT Headlines"
description: |
  Analysis of NYT headlines from 1996 to 2005 
author: Anjali Suva
date: October 6, 2025
format:
  html:
...
#create df for average length of nyt article titles 
...
```{r}
#| fig-alt: "Bar chart of average NYT article title length by year, from 1996 to 2005."

#loading ggplot and my custom theme
library(ggplot2)
source("R/theme_asuva.R")

#create bar chart of avg NYT article title length 
ggplot(AvgTitleLength, aes(x = Year, y = AvgTitleLength)) +
  geom_col(fill = "mistyrose3") +
...
#create tibble of number of times Iraq appeared in headline title
...
```{r}
#| fig-alt: "Line chart of number of times 'Iraq' Appeared in NYT headlines by year, from 1996 to 2005."

#graph previous tibble
ggplot(IraqHeadlines, aes(x = Year, y = IraqinTitle)) +
  geom_point() +
  geom_smooth(se = FALSE, color = "mistyrose3") +
...
#create df to extract key words in title 
...
#filter data to find key introductory words in the title 
